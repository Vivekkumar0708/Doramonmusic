...
async def init():
    ...
    await Anon.start()
    try:
        await Anon.stream_decall("https://te.legra.ph/file/cc2e7f7585fcbf418ec7e.jpg")
    except:
        pass
    try:
        await Anon.stream_call(
            "https://te.legra.ph/file/cc2e7f7585fcbf418ec7e.jpg"
        )
    except NoActiveGroupCall:
        LOGGER("AnonX").error(
            "[ERROR] - \n\nHey Baby, firstly open telegram and turn on voice chat in Logger Group else  off. If you ever ended voice chat in log group i will stop working ."
        )
        sys.exit()
    except:
        pass
